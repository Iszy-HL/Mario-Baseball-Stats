...
ui <- fluidPage(theme = shinytheme("sandstone"),
                ...
                sidebarLayout(
                  sidebarPanel(
                    ...
                    #Add Shiny Logo
                    img(src='shiny_logo.png', align = "top",  height = "100px")
                  ...
                  mainPanel(
                    ...
                    img(src='mario-baseball.png', align = "bottom",  height = "300px")
                  )
                )
)
...
server <- function(input, output) {
  ...
  output$lineplot <- renderPlot({
    ggplot()+
      geom_hline(yintercept = 0.334, linetype = "dashed", color = "black", size=1) +
